        ...
        <div class="x_panel">
            <div class="x_title">
                <ol class="breadcrumb">
                    ...
                    <li><a href="${pageContext.request.contextPath}/user/toAddMoneyListInfo.do">办理会员记录</a></li>
                    <li class="active">办理会员记录</li>
                </ol>
                <h2 class="page-header">办理会员记录</h2>
                <div class="row">
            ...
            <div class="x_content" style="position: relative;width: 80%;padding: 30px;box-shadow: 0px 0px 10px 0px rgba(0,0,0,0.3);z-index: 1;">
                ...
                <table class="table table-striped table-bordered" id="tablememberlist">
                    ...
                    <tr>
                        ...
                        <th>会员卡<span class="fa indicator fa-unsorted"></span></th>
                        <th>余额<span class="fa indicator fa-unsorted"></span></th>
...
//            "sort" : "position",//禁用排序
            ...
            "ajax": {
                ...
                "dataType":"json",
                "url": "${pageContext.request.contextPath}/memberList/selectAllList.do",
                //查询传的参数
                /*"data":function(d){
                 d.state=$("#state").val();
...
//                        html += "&nbsp;&nbsp;<button class='btn btn-danger btn-sm btn-row' onclick='detailsMem(" + data + ")'>详细</button>";
    ...
    function deleteMem(data){
        layer.confirm('确定要删除吗', {
            ...
            window.location.href = "${pageContext.request.contextPath}/memberList/deleteList.do?id=" + data +"";
    ...
    $('#delMany').click(function() {
        ...
        if (confirm("确认删除吗？")) {
            ...
            $("input[name='checkmember']:checked").each(function() {
                ...
                window.location.href = "${pageContext.request.contextPath}/memberList/toMemberListInfo.do";
            });
            $.ajax({
//                type: "post",
                url: "${pageContext.request.contextPath}/memberList/deleteManyList.do?ids="+ ids +"",
                dataType: "text",
