...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
        <div class="x_title">
            ...
            <h2 class="page-header">添加教练</h2>
        </div>
        <div class="form-horizontal">
            <div class="ibox-content">

                <form action="${pageContext.request.contextPath}/coach/addCoach.do" id="commentForm" onsubmit="return validateForm();">
                    <div class="form-group">
                        <label class="col-sm-2 control-label">姓名：</label>
                        <div class="col-sm-8 group-print">
                            <input type="text" name="coachName" id="coachName" class="form-control" placeholder="请输入名字"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 group-print">
                            <input type="radio" name="coachSex" value="男" />男
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 group-print">
                            <input type="text" name="coachAge" id="coachAge" class="form-control" placeholder="请输入年龄"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 group-print">
                            <input type="text" name="coachEdu" id="coachEdu" class="form-control" placeholder="请输入学历"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 group-print">
                            <input type="text" name="coachExp" id="coachExp" class="form-control" placeholder="请输入运动经历"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 group-print">
                            <input type="text" name="coachCert" id="coachCert" class="form-control" placeholder="请输入曾经获得的证书"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 group-print">
                            <input type="text" name="coachAdv" id="coachAdv" class="form-control" placeholder="请输入个人特长"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 group-print">
                            <input type="text" name="coachMotto" id="coachMotto" class="form-control" placeholder="请输入个人格言"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 group-print">
                            <input type="text" name="coachPhone" id="coachPhone" class="form-control" placeholder="请输入电话"/>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-8 group-print">
                            <div class="btn-group">
                                <label class="btn btn-primary" >
                                    <button type="button" class="btn btn-primary"  data-toggle="modal" data-target="#uploadFileDownload">上传头像</button>
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10 col-sm-offset-2">
                            <button class="btn btn-primary col-sm-5 btn-submit" id="submit" type="submit">添  加</button>
...
<script type="text/javascript">
    ...
    function validateForm()
    {
        ...
        var sex = document.getElementsByName("coachSex");
