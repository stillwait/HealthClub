...
<%@ page import="com.club.Po.EquipmentOrder" %><%--
...
<%
    EquipmentOrder equipmentOrder = (EquipmentOrder)request.getAttribute("equipmentOrder");
%>
    ...
    <div class="x_panel">
        <div class="x_title">
            <ol class="breadcrumb">
                ...
                <li><a href="${pageContext.request.contextPath}/user/toEquOrderInfo.do">器材花费</a></li>
        ...
        <div class="form-horizontal">
            <div class="ibox-content">
                ...
                <form action="${pageContext.request.contextPath}/equipment/editEquOrder.do" id="commentForm" onsubmit="return validateForm();">

                    <input type="hidden" name="orderId" value="<%=equipmentOrder.getOrderId()%>">
                    <input type="hidden" name="equId" value="<%=equipmentOrder.getEquId()%>">

                    <div class="form-group">
                        <label class="col-sm-2 control-label">器材名称：</label>
                        <div class="col-sm-8 group-print">
                            <input type="text" name="equName" id="equName" class="form-control" value="<%=equipmentOrder.getEquName()%>"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 group-print">
                            <input type="text" name="equNumber" id="equNumber" class="form-control" onkeyup="add()" value="<%=equipmentOrder.getEquNumber()%>"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 group-print">
                            <input type="text" name="equPrice" id="equPrice" class="form-control" onkeyup="add()" value="<%=equipmentOrder.getEquPrice()%>"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 group-print">
                            <input type="text" name="equMoney" id="equMoney" class="form-control" onClick="add()" value="<%=equipmentOrder.getEquMoney()%>"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 group-print">
                            <input type="date" id="equDate" name="equDate" value="<%=equipmentOrder.getEquDate()%>"/>
                        </div>
                    </div>
