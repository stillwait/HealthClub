        ...
        <div class="x_panel">
            <div class="x_title">
                <ol class="breadcrumb">
                    ...
                    <li><a href="${pageContext.request.contextPath}/user/toEquipmentInfo.do">健身器材管理</a></li>
...
<script type="text/javascript">
    ...
    function deleteEqu(data){
        layer.confirm('确定要删除吗', {
            ...
            window.location.href = "${pageContext.request.contextPath}/equipment/deleteEquipment.do?id=" + data +"";
    ...
    $('#delMany').click(function() {
        ...
        if (confirm("确认删除吗？")) {
            ...
            $("input[name='checkproject']:checked").each(function() {
                ...
                window.location.href = "${pageContext.request.contextPath}/user/toEquipmentInfo.do";
            });
            $.ajax({
//                type: "post",
                url: "${pageContext.request.contextPath}/equipment/deleteManyEquipment.do?ids="+ ids +"",
                dataType: "text",
