...
<%
    UserSalary userSalary = (UserSalary) request.getAttribute("userSalary");
%>
...
<div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
        <div class="x_title">
            ...
            <h2 class="page-header">员工工资</h2>
        </div>
        <div class="form-horizontal">
            <div class="ibox-content">

                <form action="${pageContext.request.contextPath}/user/editUserSalary.do" id="commentForm" onsubmit="return validateForm();">

                    <input type="hidden" name="id" value="<%=userSalary.getId()%>">
                    <input type="hidden" name="userId" value="<%=userSalary.getUserId()%>">

                    <div class="form-group">
                        <label class="col-sm-2 control-label">姓名：</label>
                        <div class="col-sm-8 group-print">
                            <input type="text" name="userName" class="form-control" value="<%=userSalary.getUserName()%>"/>
                        </div>
                    </div>

                    <input type="hidden" name="userRole" value="<%=userSalary.getUserRole()%>">

                    <div class="form-group">
                        <label class="col-sm-2 control-label">年份：</label>
                        <div class="col-sm-8 group-print">
                            <input type="text" name="year" class="form-control" value="<%=userSalary.getYear()%>"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 group-print">
                            <input type="text" name="month" class="form-control" value="<%=userSalary.getMonth()%>"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 group-print">
                            <input type="text" name="baseSalary" class="form-control" value="<%=userSalary.getBaseSalary()%>"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 group-print">
                            <input type="text" name="cqts" class="form-control" value="<%=userSalary.getCqts()%>"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 group-print">
                            <input type="text" name="qqts" class="form-control" value="<%=userSalary.getQqts()%>"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 group-print">
                            <input type="text" name="overTime" class="form-control" value="<%=userSalary.getOverTime()%>"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 group-print">
                            <input type="text" name="overSalary" class="form-control" value="<%=userSalary.getOverSalary()%>"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 group-print">
                            <input type="text" name="jiangJin" class="form-control" value="<%=userSalary.getJiangJin()%>"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 group-print">
                            <input type="text" name="yfSalary" class="form-control" value="<%=userSalary.getYfSalary()%>"/>
                        </div>
                    </div>
