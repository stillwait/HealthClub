            ...
            <div class="x_title">
                ...
                <div class="row">
                    <div style="position: absolute;z-index: 2;margin-left: 69%;top: 170px">
                        <a href="${pageContext.request.contextPath}/card/toAddCard.do" class="btn btn-success btn-sm btn-row" id="addMem">添加会员卡</a>
                    </div>
                </div>
            </div>
...
//            "sort" : "position",//禁用排序
            ...
            "ajax": {
                ...
                "dataType":"json",
                "url": "${pageContext.request.contextPath}/card/selectAllList.do",
                "data": function (d) {
    ...
    function updateUser(data){
        window.location.href = "${pageContext.request.contextPath}/card/toEditCard.do?id=" + data +"";
    }
    ...
    function deleteUser(data){
        layer.confirm('确定要删除吗', {
            ...
            window.location.href = "${pageContext.request.contextPath}/card/deleteCard.do?id=" + data +"";
