    ...
    <div class="x_panel">
        <div class="x_title">
            <ol class="breadcrumb">
                ...
                <li><a href="${pageContext.request.contextPath}/project/toProjectInfo2.do">项目信息</a></li>
        ...
        <div class="form-horizontal">
            <div class="ibox-content">
                ...
                <form action="${pageContext.request.contextPath}/member/addMemProject2.do" id="commentForm" onsubmit="return validateForm();">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 group-print">
                            <input type="text" name="cardType" id="cardType" class="form-control" readonly unselectable="on" value="<%=memberCardProList.get(0).getCard().getCardName() + "/" + memberCardProList.get(0).getCard().getCardBenefit()%>"/>
                        </div>
                    </div>
...
//                alert(JSON.stringify(data[0].price[0]));
//                alert(data[0].price.length);
    ...
    function validateForm()
    {
        ...
        if(isNaN(realMoney)){
            ...
            return false;
        }else if(realMoney.valueOf()<0) {
            layer.msg('不能是负数', {shift: 6,time:2000});
            return false;
        }else if(realMoney.valueOf() == 0){
            layer.msg('不能为空', {shift: 6,time:2000});
            return false;
