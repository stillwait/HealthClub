    ...
    <div class="x_panel">
        ...
        <div class="form-horizontal">
            <div class="ibox-content">
                ...
                <form action="${pageContext.request.contextPath}/price/addPrice.do" id="commentForm" onsubmit="return validateForm();">

                    <div class="form-group">
                        <label class="col-sm-2 control-label">类型：</label>
                        <div class="col-sm-8 group-print">
                            <input type="text" name="priceName" id="priceName" class="form-control" placeholder="例如*三个月"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 group-print">
                            <input type="text" name="priceMoney" id="priceMoney" class="form-control" placeholder="请输入价格"/>
                        </div>
                    </div>
