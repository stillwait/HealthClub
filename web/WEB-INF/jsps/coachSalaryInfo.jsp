        ...
        <div class="x_panel">
            <div class="x_title">
                <ol class="breadcrumb">
                    ...
                    <li><a href="${pageContext.request.contextPath}/user/toCoachSalaryInfo.do">教练管理</a></li>
                    <li class="active">教练工资</li>
                </ol>
                <h2 class="page-header">教练工资</h2>
                <div class="row">
                    <div style="position: absolute;z-index: 2;margin-left: 69%;top: 170px">
                        <a href="${pageContext.request.contextPath}/coach/toAddCoachSalary.do" class="btn btn-success btn-sm btn-row" id="addMem">添加教练工资</a>
...
//            "sort" : "position",//禁用排序
            ...
            "ajax": {
                ...
                "dataType":"json",
                "url": "${pageContext.request.contextPath}/coach/selectAllCoachSalary.do",
                "data": function (d) {
    ...
    function updateUser(data){
        window.location.href = "${pageContext.request.contextPath}/coach/toEditCoachSalary.do?id=" + data;
    }
    ...
    function deleteUser(data){
        layer.confirm('确定要删除吗', {
            ...
            window.location.href = "${pageContext.request.contextPath}/coach/deleteCoachSalary.do?id=" + data +"";
    ...
    $('#delMany').click(function() {
        ...
        if (confirm("确认删除吗？")) {
            ...
            $("input[name='checkuser']:checked").each(function() {
                ...
                window.location.href = "${pageContext.request.contextPath}/coach/toCoachSalaryInfo.do";
            });
            $.ajax({
//                type: "post",
                url: "${pageContext.request.contextPath}/coach/deleteManyCoachSalary.do?ids="+ ids +"",
                dataType: "text",
