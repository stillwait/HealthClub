        ...
        <div class="x_panel">
            <div class="x_title">
                <ol class="breadcrumb">
                    ...
                    <li><a href="${pageContext.request.contextPath}/user/toAddMoneyListInfo.do">会员充值记录</a></li>
                    <li class="active">会员充值记录</li>
                </ol>
                <h2 class="page-header">会员充值记录</h2>
                <div class="row">
            ...
            <div class="x_content" style="position: relative;width: 80%;padding: 30px;box-shadow: 0px 0px 10px 0px rgba(0,0,0,0.3);z-index: 1;">
                ...
                <table class="table table-striped table-bordered" id="tablememberlist">
                    ...
                    <tr>
                        ...
                        <th>充值<span class="fa indicator fa-unsorted"></span></th>
                        <th>之前余额<span class="fa indicator fa-unsorted"></span></th>
...
//            "sort" : "position",//禁用排序
            ...
            "ajax": {
                ...
                "dataType":"json",
                "url": "${pageContext.request.contextPath}/addMoneyList/selectAllList.do",
                "data": function (d) {
...
//                        html += "&nbsp;&nbsp;<button class='btn btn-danger btn-sm btn-row' onclick='detailsMem(" + data + ")'>详细</button>";
    ...
    function deleteMem(data){
        layer.confirm('确定要删除吗', {
            ...
            window.location.href = "${pageContext.request.contextPath}/addMoneyList/deleteList.do?id=" + data +"";
    ...
    $('#delMany').click(function() {
        ...
        if (confirm("确认删除吗？")) {
            ...
            $("input[name='checkmember']:checked").each(function() {
                ...
                window.location.href = "${pageContext.request.contextPath}/user/toAddMoneyListInfo.do";
            });
            $.ajax({
//                type: "post",
                url: "${pageContext.request.contextPath}/addMoneyList/deleteManyList.do?ids="+ ids +"",
                dataType: "text",
