...
//            "sort" : "position",//禁用排序
            ...
            "ajax": {
                ...
                "dataType":"json",
                "url": "${pageContext.request.contextPath}/user/selectAllUserSalary.do",
                "data": function (d) {
    ...
    function updateUser(data){
        window.location.href = "${pageContext.request.contextPath}/user/toEditUserSalary.do?id=" + data;
    }
    ...
    function deleteUser(data){
        layer.confirm('确定要删除吗', {
            ...
            window.location.href = "${pageContext.request.contextPath}/user/deleteUserSalary.do?id=" + data +"";
    ...
    $('#delMany').click(function() {
        ...
        if (confirm("确认删除吗？")) {
            ...
            $("input[name='checkuser']:checked").each(function() {
                ...
                window.location.href = "${pageContext.request.contextPath}/user/toUserSalaryInfo.do";
            });
            $.ajax({
//                type: "post",
                url: "${pageContext.request.contextPath}/user/deleteManyUserSalary.do?ids="+ ids +"",
                dataType: "text",
