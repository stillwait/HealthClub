        ...
        <div class="x_panel">
            <div class="x_title">
                <ol class="breadcrumb">
                    ...
                    <li><a href="${pageContext.request.contextPath}/project/toProjectInfo2.do">健身项目管理</a></li>
                    <li class="active">项目概况</li>
                </ol>
                <h2 class="page-header">项目概况</h2>
                <div class="row">
                    <div style="position: absolute;z-index: 2;margin-left: 69%;top: 170px">
                        <a href="${pageContext.request.contextPath}/member/toAddMemProject2.do?id=<%=member.getMemId()%>" class="btn btn-success btn-sm btn-row" id="addMem">办理健身</a>
                    </div>
                </div>
            </div>
