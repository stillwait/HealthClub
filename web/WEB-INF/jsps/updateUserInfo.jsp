    ...
    <div class="x_panel">
        ...
        <div class="form-horizontal">
            <div class="ibox-content">
                ...
                <form action="${pageContext.request.contextPath}/user/updateUserInfo.do" id="commentForm">
                    <div class="form-group">
                        <label class="col-sm-2 control-label">工号：</label>
                        <div class="col-sm-8 group-print">
                            <input type="text" name="adminId" class="form-control" readonly unselectable="on" value="<%=admin.getAdminId()%>"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 group-print">
                            <input type="password" name="adminPwd" class="form-control" value="<%=admin.getAdminPwd()%>"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 group-print">
                            <input type="text" name="adminName" class="form-control" value="<%=admin.getAdminName()%>"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 group-print">
                            <input type="radio" name="adminSex" id="man" value="男" />男
                            <input type="radio" name="adminSex" id="women" value="女" />女
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 group-print">
                            <input type="text" name="adminAge" class="form-control" value="<%=admin.getAdminAge()%>"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8 group-print">
                            <input type="text" name="adminPhone" class="form-control" value="<%=admin.getAdminPhone()%>"/>
                        </div>
                    </div>
                    ...
                    <input type="text" id="downloadUrl" class="hidden" name="adminPic">
